...
<head>
    <meta charset="utf-8" />
    <link rel="icon" sizes="250x250" href="./assets/img/icon.png">
...
<body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="http://localhost/Plant%20Zone/index.php" class="navbar-brand" rel="tooltip" title="" data-placement="bottom" target="">
                    Blood Bank
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/feedback/">
                            <i class="now-ui-icons files_paper"></i>
                            <p>Feedback</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="pages/chatbot_index.php" class="nav-link" onclick="scrollToDownload()">
                            <i class="now-ui-icons education_paper"></i>
                            <p>Talk to us</p>
                        </a>
                    </li>
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="green">
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/homepage.jpg');">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="typography-line">
                            <p>
                            “Gardening is about enjoying the smell of things growing in the soil, getting dirty without feeling guilty, and generally taking the time to soak up a little peace and serenity"</p>
                        </div>
                        <br>
...
?>   
    <div class="row-sm-3">
        ...
        <div class="caption">
          ...
          <h6><a class="btn btn-success btn-round" title="Click for more details!" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-right">Rs<?php echo $res['prod_price']; ?></medium></h6>
        </div>
